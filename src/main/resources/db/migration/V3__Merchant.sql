...
CREATE TABLE tb_merchant_pruducts_sold
(
    merchant_id  BIGINT NOT NULL,
...
ALTER TABLE tb_merchant_pruducts_sold
    ADD CONSTRAINT fk_tb_merchant_pruducts_sold_on_merchant FOREIGN KEY (merchant_id) REFERENCES tb_merchant (id);
